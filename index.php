...
session_name("taller");
session_start();
$_controllers_permitidos = array("documento","notificacion","usuario","bitacora","usuario","cargo","privilegio","calendario","archivo_config","area","tipo_documento","backup","estado_documento","plantilla","reporte");
if (!isset($_REQUEST['c'])) {
