    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label>Sigla</label>
                <input type="text" name="nombre" class="form-control" placeholder="Ingrese la sigla" required >
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label>Nombre</label>
                <input type="text" name="sigla" class="form-control" placeholder="Ingrese el nombre del tipo de documento" required />
            </div>
        </div>
    </div>
    <br>
